...
public class NextLarger
{
    ...
    Given an array a composed of distinct elements, find the next larger element for each element of the array, i.e. the first element to the right that is greater than this element,
    in the order in which they appear in the array, and return the results as a new array of the same length.
    ...
    {
        int[] a={6,7,3,8};
        NextLarger obj=new NextLarger();
        int[] ret=obj.nextLarger(a);
